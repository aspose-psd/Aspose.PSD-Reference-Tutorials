...
2.  مكتبة Aspose.PSD: قم بتنزيل مكتبة Aspose.PSD ودمجها في مشروع Java الخاص بك. يمكنك العثور على الموارد اللازمة في[توثيق](https://reference.aspose.com/psd/java/).
