...
## Adım 2: Çıktı Dosyası Adını Belirleyin
...
```
 ...
 Bir örneğini oluşturun`Image` davet ederek`create` yapılandırılmış olanı geçerek yöntem`BmpOptions` ve görüntünün boyutlarını belirtme.
