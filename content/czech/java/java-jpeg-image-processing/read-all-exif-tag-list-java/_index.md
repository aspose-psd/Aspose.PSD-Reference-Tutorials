...
description: Naučte se extrahovat EXIF metadata ze souborů PSD pomocí Aspose.PSD for Java s naším komplexním tutoriálem a příklady kódu.
type: docs
weight: 16
...
-  Stažena knihovna Aspose.PSD pro Java. Můžete jej získat z[tady](https://releases.aspose.com/psd/java/).
## Importujte balíčky
...
### Jak mohu získat dočasnou licenci pro Aspose.PSD pro Java?
 Návštěva[tady](https://purchase.aspose.com/temporary-license/) pro dočasné licenční možnosti.
