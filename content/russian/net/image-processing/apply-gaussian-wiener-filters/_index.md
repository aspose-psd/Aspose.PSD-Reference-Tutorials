...
3. Интегрированная среда разработки (IDE): в вашей системе должна быть установлена .NET-совместимая IDE, например Visual Studio, для беспрепятственной реализации фрагментов кода, представленных в этом руководстве.
