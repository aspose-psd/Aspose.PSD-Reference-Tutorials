...
Поздравляем! Вы успешно построили прямоугольники с помощью Aspose.PSD для .NET. Из этого руководства вы узнаете, как легко интегрировать манипуляции с изображениями в ваши .NET-приложения.
