...
Αυτό είναι όλο! Προσθέσατε με επιτυχία ένα εφέ επικάλυψης κλίσης σε ένα επίπεδο χρησιμοποιώντας το Aspose.PSD για .NET.
...
### Ε3: Πού μπορώ να βρω περισσότερα παραδείγματα και τεκμηρίωση;
 ...
 A3: Επισκεφθείτε το[απόδειξη με έγγραφα](https://reference.aspose.com/psd/net/) για λεπτομερή παραδείγματα και οδηγίες.
