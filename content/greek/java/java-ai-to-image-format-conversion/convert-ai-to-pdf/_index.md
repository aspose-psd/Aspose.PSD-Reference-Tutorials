...
### Ποιες μορφές αρχείων υποστηρίζει το Aspose.PSD;
 Το Aspose.PSD υποστηρίζει μια ποικιλία μορφών, όπως PSD, AI, TIFF, BMP και άλλα. Ελεγξε το[τεκμηρίωση](https://reference.aspose.com/psd/java/) για την πλήρη λίστα.
