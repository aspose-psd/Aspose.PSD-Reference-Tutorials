...
A2: Ναι, το Aspose.PSD για Java προσφέρει διάφορους τύπους αλλαγής μεγέθους, όπως Nearest Neighbor, Bicubic και άλλα. Εξερευνήστε την τεκμηρίωση για μια ολοκληρωμένη λίστα.
