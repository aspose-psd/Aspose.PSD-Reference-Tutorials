...
## ขั้นตอนที่ 1: โหลดภาพ
 ...
 เริ่มต้นด้วยการโหลดรูปภาพ PSD ตัวอย่างลงในอินสแตนซ์ของ`RasterImage` ชั้นเรียน นี่คือรากฐานสำหรับการปรับแกมมาในภายหลัง
...
## ขั้นตอนที่ 2: ปรับแกมมา
 ...
 ตอนนี้ ปรับแกมม่าของภาพที่โหลดโดยใช้`adjustGamma` วิธี. ปรับค่าแกมมาอย่างละเอียดตามความต้องการของคุณ
...
ยินดีด้วย! คุณได้ปรับแกมม่าของรูปภาพโดยใช้ Aspose.PSD สำหรับ Java สำเร็จแล้ว กระบวนการนี้ช่วยให้นักพัฒนาปรับปรุงคุณภาพของภาพได้อย่างง่ายดาย ส่งผลให้ผู้ใช้ได้รับประสบการณ์ที่น่าดึงดูดทางสายตา
