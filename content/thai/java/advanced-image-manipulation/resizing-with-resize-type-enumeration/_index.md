...
## ขั้นตอนที่ 1: โหลดภาพ
 ...
 เริ่มต้นด้วยการโหลดรูปภาพที่มีอยู่ลงในอินสแตนซ์ของ`RasterImage` ชั้นเรียน ใช้ข้อมูลโค้ดต่อไปนี้:
...
ตอบ 2: ใช่ Aspose.PSD สำหรับ Java มีประเภทการปรับขนาดที่หลากหลาย เช่น Nearest Neighbor, Bicubic และอื่นๆ อีกมากมาย สำรวจเอกสารเพื่อดูรายการที่ครอบคลุม
