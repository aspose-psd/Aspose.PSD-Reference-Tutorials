---
title: Support Blwh Resource in PSD Files with Java
linktitle: Support Blwh Resource in PSD Files with Java
second_title: Aspose.PSD Java API
description: 
type: docs
weight: 11
url: /java/working-with-psd-files/support-blwh-resource-psd-files/
---
