...
# Applica l'effetto colore di rendering in Aspose.PSD per Java
...
-  Aspose.PSD per Java: scarica e installa la libreria Aspose.PSD da[questo collegamento](https://releases.aspose.com/psd/java/).
