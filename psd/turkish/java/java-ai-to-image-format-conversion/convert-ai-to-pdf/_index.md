...
Aspose.PSD, geliştiricilerin Java’da Photoshop ve Illustrator dosyalarıyla çalışmasını sağlayan güçlü bir kütüphanedir. PSD ve AI dosyalarını okuma, yazma ve dönüştürme yeteneklerine sahiptir.

### Aspose.PSD'yi ücretsiz deneyebilir miyim?
Evet! Geçici bir lisans alabilir veya [Aspose Releases](https://releases.aspose.com/psd/java/) adresinden ücretsiz deneme sürümünü indirebilirsiniz.

### Aspose.PSD hangi dosya formatlarını destekler?
Aspose.PSD, PSD, AI, TIFF, BMP ve daha fazlası dahil olmak üzere çeşitli formatları destekler. Tam liste için [belgelere](https://reference.aspose.com/psd/java/) bakın.

### Aspose.PSD için destek nasıl alabilirim?
Herhangi bir sorunuz veya karşılaştığınız bir sorun için [Aspose Forum](https://forum.aspose.com/c/psd/34) adresini ziyaret edebilirsiniz.

### Aspose.PSD için lisansı nereden satın alabilirim?
Lisansı doğrudan [Aspose'un satın alma sayfasından](https://purchase.aspose.com/buy) temin edebilirsiniz.
