...
-  Belge ve Çıktı Dizinleri: PSD belgeniz ve istediğiniz çıktı için dizinleri ayarlayın. Değiştir`baseFolder` Ve`outputFolder` örnekteki değişkenler buna göre.
