---
date: 2025-12-22
description: Ismerje meg, hogyan konvertálhatja a PSD-t PNG-re egy adatfolyamból az
  Aspose.PSD for Java segítségével. Kövesse ezt a lépésről‑lépésre útmutatót a PSD-fájlok
  betöltéséhez és PNG‑képekké exportálásához.
linktitle: Loading Images from Stream
second_title: Aspose.PSD Java API
title: PSD konvertálása PNG-re streamből az Aspose.PSD for Java-val
