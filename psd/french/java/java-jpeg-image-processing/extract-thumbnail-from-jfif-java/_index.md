...
Vous pouvez éventuellement extraire les données EXIF de la ressource miniature si nécessaire.
```java
...
```
Cette étape vous permet de récupérer et de travailler avec les informations EXIF associées à la vignette.
