...
Aspose.PSD for Java — это библиотека, позволяющая разработчикам программно работать с файлами Photoshop PSD, используя Java.

### Можно ли использовать Aspose.PSD в бесплатном проекте?
Да, библиотеку можно попробовать бесплатно, используя trial‑версию, доступную на сайте Aspose.

### Какие типы модификаций можно выполнять в PSD‑файлах?
Можно управлять слоями, формами, текстом, операциями пути и многим другим внутри PSD‑файлов.

### Совместима ли Aspose.PSD с другими языками программирования?
Да, Aspose предлагает различные библиотеки для разных языков, включая .NET и Python.

### Где найти документацию по Aspose.PSD?
Полную документацию можно открыть [здесь](https://reference.aspose.com/psd/java/).
