...
Aspose.PSD for Java — это библиотека, позволяющая разработчикам манипулировать PSD‑файлами внутри их Java‑приложений.

### Можно ли использовать Aspose.PSD бесплатно?
Да! Вы можете начать с бесплатной пробной версии, доступной [here](https://releases.aspose.com/).

### Как установить Aspose.PSD for Java?
Вы можете скачать её по [this link](https://releases.aspose.com/psd/java/).

### Есть ли поддержка Aspose.PSD?
Да, существует специальный [support forum](https://forum.aspose.com/c/psd/34).

### Какие типы ресурсов можно манипулировать в PSD‑файле?
Вы можете работать с различными ресурсами, включая слои, слои‑заполнения и SoCo‑ресурсы внутри PSD‑файла.
