...
## レコード長プロパティをサポートするために Aspose.PSD for Java を使用する理由
...
## ステップ 1: ソースディレクトリと出力ディレクトリを設定する
...
## 長さレコードプロパティをサポートするPSDファイルのバッチ処理方法
