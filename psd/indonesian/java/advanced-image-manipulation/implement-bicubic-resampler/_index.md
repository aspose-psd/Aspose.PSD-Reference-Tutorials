...
# Menerapkan Bicubic Resampler di Aspose.PSD untuk Java
...
Mulailah dengan memuat gambar yang ingin Anda ubah ukurannya ke dalam aplikasi Java Anda. Gunakan`Image.load` metode dari Aspose.PSD.
