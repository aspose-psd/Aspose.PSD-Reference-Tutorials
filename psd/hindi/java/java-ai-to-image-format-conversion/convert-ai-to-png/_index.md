...
### What is Aspose.PSD?
Aspose.PSD एक जावा लाइब्रेरी है जो डेवलपर्स को PSD (Photoshop) और अन्य Adobe फ़ाइल फ़ॉर्मेट के साथ काम करने की सुविधा देती है। यह संपादन, रूपांतरण और रेंडरिंग जैसे विभिन्न ऑपरेशन्स को सपोर्ट करती है।

### Can I use Aspose.PSD for free?
आप Aspose.PSD को एक [मुक्त ट्रायल](https://releases.aspose.com/) के साथ उपयोग कर सकते हैं, लेकिन पूरी कार्यक्षमता के लिए आपको लाइसेंस खरीदना होगा। आप मूल्यांकन के लिए एक [अस्थायी लाइसेंस](https://purchase.aspose.com/temporary-license/) भी प्राप्त कर सकते हैं।

### What file formats does Aspose.PSD support?
Aspose.PSD PSD, PSB, AI और अन्य Adobe फ़ाइल फ़ॉर्मेट को सपोर्ट करता है। यह PNG, JPEG, BMP, और TIFF जैसे विभिन्न इमेज फ़ॉर्मेट में रूपांतरण की अनुमति देता है।

### Is Aspose.PSD compatible with all versions of Java?
Aspose.PSD JDK 8 और उससे ऊपर के संस्करणों के साथ संगत है। सुनिश्चित करें कि आपके पास उपयुक्त JDK संस्करण स्थापित है।
