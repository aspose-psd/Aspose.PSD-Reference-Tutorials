...
如果你打算使用渐变填充来增强你的设计，我们的教程[在 PSD 文件中添加渐变填充层](./add-gradient-fill-layer-psd-files/)正是您所需要的。本指南将向您展示如何修改颜色和透明度等渐变属性，从而轻松创建引人注目的效果。
...
### [使用 Aspose.PSD Java 设置 PSD 图层的填充不透明度](./set-fill-opacity-psd-layers/)
