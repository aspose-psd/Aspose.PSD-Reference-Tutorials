...
Aspose.PSD for Java เป็นไลบรารีที่ช่วยให้นักพัฒนาสามารถจัดการไฟล์ PSD ภายในแอปพลิเคชัน Java ของตนได้

### ฉันสามารถใช้ Aspose.PSD ฟรีได้หรือไม่?
ใช่! คุณสามารถเริ่มต้นด้วยการทดลองใช้ฟรีที่มีให้ [here](https://releases.aspose.com/)

### ฉันจะติดตั้ง Aspose.PSD for Java อย่างไร?
คุณสามารถดาวน์โหลดได้จาก [this link](https://releases.aspose.com/psd/java/)

### มีการสนับสนุนสำหรับ Aspose.PSD หรือไม่?
มี, มีฟอรั่มสนับสนุนเฉพาะทาง [support forum](https://forum.aspose.com/c/psd/34)

### ฉันสามารถจัดการทรัพยากรประเภทใดในไฟล์ PSD?
คุณสามารถจัดการทรัพยากรหลายประเภท รวมถึงเลเยอร์, fill layers, และ SoCo resources ภายในไฟล์ PSD
