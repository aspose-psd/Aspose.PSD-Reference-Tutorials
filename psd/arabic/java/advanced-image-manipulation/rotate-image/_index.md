...
# قم بتدوير الصورة في Aspose.PSD لـ Java
...
-  نموذج ملف PSD: قم بإعداد نموذج ملف PSD الذي تريد تدويره. ضبط`sourceFile` متغير في رمز المثال مع المسار إلى ملف PSD الخاص بك.
