...
# أضف توقيعًا إلى صورة باستخدام Aspose.PSD لـ Java
...
## الخطوة 3: إضافة التوقيع إلى الصورة
 ...
 استخدم`DrawImage` طريقة لإضافة التوقيع إلى الصورة الأساسية. اضبط الموقع حسب الحاجة. في هذا المثال، نحاول وضع الصورة الثانوية في أسفل يمين الصورة الأساسية:
