...
# الثنائية مع عتبة Otsu في Aspose.PSD لـ Java
...
A1: يعتبر Binarization باستخدام عتبة Otsu أسلوبًا يستخدم لتجزئة الصورة، وفصل الصورة إلى مقدمة وخلفية استنادًا إلى العتبة المثالية.
