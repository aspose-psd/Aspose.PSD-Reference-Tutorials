---
title: "Create CMYK Channel Mixer Adjustment Layer in PSD – Java"
linktitle: "Create CMYK Channel Mixer Adjustment Layer in PSD – Java"
second_title: "Aspose.PSD Java API"
description: "Learn how to create cmyk channel mixer adjustment layers in PSD files using Aspose.PSD for Java. Step‑by‑step guide with code samples."
weight: 22
...
# Create CMYK Channel Mixer Adjustment Layer in PSD – Java
...
## Quick Answers
- **What does “create cmyk channel mixer” mean?** It means adding a CMYK Channel Mixer adjustment layer to a PSD programmatically.  
- **Which library handles this?** Aspose.PSD for Java provides full support for RGB and CMYK channel mixers.  
- **Do I need Photoshop installed?** No, the API works independently of Photoshop.  
...
## How to create cmyk channel mixer adjustment layer
...
- **No Photoshop required:** Work with PSD files on any server or CI pipeline.  
...
- **Path separators:** Use `File.separator` for cross‑platform compatibility.  
- **Channel index mapping:** CMYK indices are 0 = Cyan, 1 = Magenta, 2 = Yellow, 3 = Black.  
- **Saving format:** Always save back to PSD to retain adjustment layers; other formats will flatten them.
